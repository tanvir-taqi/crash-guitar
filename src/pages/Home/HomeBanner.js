    ...
    return (
        <div>
               <div className="container md:mx-auto md:p-6 p-2 md:py-20  my-10  flex flex-col md:flex-row items-center gap-6" >
                ...
                <Link to='/category/637f2edd9d527a385fa73f01' className='text-cyan-600  font-bold hover:bg-cyan-500 hover:text-white mt-4 border-b-4 border-r-4 border-b-cyan-500 border-r-cyan-500 py-2 px-8 rounded-tr-3xl  '>Grab Yours Now!!!</Link>
                </div>
